    ...
    <body>
        ...
        <container id="container">
            <section id="secao">
                ...
                <article id="conteudo">    
                <div id="secao2">
                    <h1> Termos de Uso </h1><br/><br/>
                    <p> Fique atento as normas de utilização e comportamento que você deve seguir para poder utilizar o site.</p>
                    <p> Tem algo a dizer?! Procure-nos para enviar sugestões de matérias, jogos, vídeos, imagens, livros, etc.</p>
                    <p> Sua mesagem será bem-vinda.</p>
                    <br/><br/>
                    <a href="#"> <p> E-mail: exemploemail@exemplo.com.br</p> </a>
                    <br/><br/>
                    <p> Além disso, estamos nas redes sociais.</p>
                    <p> Siga-nos no Twitter, curta-nos no Facebook, compartilhe-nos no Google+ ou ainda, inscreva-se no nosso canal do Youtube.</p> <br/><br/>
                    <a href="#"> <p> Twitter </p> </a> 
                    <a href="#"> <p> Facebook </p> </a> 
                    <a href="#"> <p> Google+ </p> </a> 
                    <a href="#"> <p> Youtube </p> </a><br/><br/><br/><br/><br/><br/>
                </div>
