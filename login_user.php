                ...
                <article id="conteudo">
                    <div id="login">
                        ...
                        <form name="formulario" action="login.php" method="post" onsubmit="return validacao();"> 
                            <p>E-mail <input type="email" name="email" placeholder="E-mail de Acesso" /> </p><br/><br/>
                            <p>Senha <input type="password" name="senha" placeholder="Senha"/> </p><br/><br/>
                            <p><input type="submit" name="submit" value="Entrar"/></p><br/>
