    ...
    <body>
        ...
        <container id="container">
            <section id="secao">
                ...
                <article id="conteudo">
                    <div id="materias2">
                        <h1> Atualização do PS Vita </h1><br/><br/>                        
                        <a href="imagens/materia_atualizacao_psvita_1.jpg" alt=""><img src="imagens/materia_atualizacao_psvita_1.jpg" alt=""></a><br/><br/><br/>
                        <p> A nova atualização obrigatória do PS VITA, a 3.18, foi lançada por questões de melhorias de aplicações e de recursos. </p>
                        <p> Porém, usuários do Reddit dizem que essa atualização não veio por questões de simples melhorias de recursos, mas, sim para corrigir falhas que permitiria que qualquer pessoa rodasse um software “caseiro” utilizando um emulador de PSP. </p><br/><br/><br/>
                        <a href="imagens/materia_atualizacao_psvita_2.jpg" alt=""><img src="imagens/materia_atualizacao_psvita_2.jpg" alt=""></a><br/><br/><br/>
                        <p> Pois há uma gama de ótimos softwares que são produzidos no Japão e raramente são comercializados com o resto do planeta e por isto as pessoas estão buscando meios de obter estes softwares. </p><br/><br/><br/><br/><br/><br/>
                    </div>                    
