            ...
            <section id="secao">
                ...
                <article id="conteudo">
                    <div id="secao2">
                        ...
                        <p> O site Multiplayer foi desenvolvido pela empresa 9Bits, com o intuito de trazer interatividade ao usuário gamer. </p>
                        <p> Aqui, nós abordamos diversas plataformas como por exemplo: PlaySstation, XBox, PC e Nintendo. </p>
                        <p> Nossa equipe é composta por programadores, estudantes do 3º ano do colégio. </p>
                        <p> Responsáveis pelo desenvolvimento do site e sua marca:</p>
                        <p> Vinicius Mocci, Jonathan Alves, Alessandro Henrique, Josimar Rodrigues, Lucas Lopes, Jessica Priscila, Gabrieli Canavezi, Larissa Gomes e João Gabriel </p><br/><br/><br/><br/><br/><br/>
                    </div>
