    ...
    <body>
        ...
        <container id="container">
            <section id="secao">
                ...
                <article id="conteudo">
                    <div id="materias2">
                        <h1> GTA V de volta em Los Santos. </h1><br/><br/>
                        <a href="imagens/materia_los_santos_gta_v_1.jpg" alt=""><img src="imagens/materia_los_santos_gta_v_1.jpg" alt=""></a><br/><br/><br/>
                        <p> Poucas franquias causam um alvoroço tão grande na comunidade gamer como Grand Theft Auto. E não é para menos! Consolidada como uma das séries mais ambiciosas de toda a indústria, GTA se renova e se torna melhor a cada novo lançamento. O mais novo jogo da franquia, GTA V, não só expande todas as possibilidades apresentadas nos jogos anteriores como também adiciona elementos revolucionários que elevam a franquia a um novo patamar. </p>
                        <p> O jogo é dividido em 3 personagens,são eles:</p>
                        <p> Michael é um ex-assaltante de bancos que vive uma vida pacata com sua família desequilibrada e passa boa parte do seu dia na beira da piscina de sua mansão em Vinewood, sempre com um copo de bebida nas mãos.</p><br/><br/><br/>
                        <a href="imagens/materia_los_santos_gta_v_2.jpg" alt=""><img src="imagens/materia_los_santos_gta_v_2.jpg" alt=""></a><br/><br/><br/>
                        <p> Em uma clara homenagem a CJ temos Franklin, um rapaz do subúrbio que executa pequenos furtos para o dono de uma revendedora de carros. Sem muita habilidade em roubo, mas excelente motorista, o rapaz quer subir na vida a todo custo, mesmo que isso lhe custe adentrar completamente no mundo do crime.</p>
                        <p> Para fechar com chave de ouro temos o mais fodão é claro Trevor(meu personagem favorito). Com uma mente completamente perturbada e uma sede incontrolável por violência de todos os tipos, o figurão arrancará risadas e suspiros de agonia de todos os jogadores. </p><br/><br/><br/><br/><br/><br/>
                    </div>                    
                ...
                <div id="colunista"> 
                    <div id="img-colunista"> <a href="imagens/colunista002.jpg" alt="" ><img src="imagens/colunista002.jpg"> </a> </div>
