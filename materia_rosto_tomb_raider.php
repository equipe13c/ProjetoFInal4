    ...
    <body>
        ...
        <container id="container">
            <section id="secao">
                ...
                <article id="conteudo">
                    <div id="materias2">
                        <h1> Rosto de Lara Croft tem mais de SETE MIL pontos de referência. </h1><br/><br/>
                        <a href="imagens/materia_rosto_tomb_raider_1.jpg" alt="" ><img src="imagens/materia_rosto_tomb_raider_1.jpg" alt=""></a><br/><br/><br/>
                        <p> Graças à tecnologia de hoje em dia é possível que os personagens de games e animações cheguem próximo a “perfeição” humana. </p>
                        <p> A dubladora de Lara Croft em Rise of the Tomb Raider, revelou a tecnologia que foi usada para criar o corpo da heroína. </p>
                        <p> A criação de personagens deste e outros jogos é feita por “pontos de referência”(pequenos pontos que capturam os mínimos detalhes de uma região do corpo e a transferem para o computador em 3D), a dubladora afirma que foram utilizados 7 MIL pontos de referência apenas no rosto da mulher como mostra a imagem abaixo.</p><br/><br/><br/>
                        <a href="imagens/materia_rosto_tomb_raider_2.jpg" alt=""><img src="imagens/materia_rosto_tomb_raider_2.jpg" alt=""></a><br/><br/><br/>
                        <p> O jogo Rise of the Tomb Raider será lançado no final do ano de 2015 e ira rodar em PS4, Xbox One e PC </p><br/><br/><br/><br/><br/><br/>
                    </div>                    
